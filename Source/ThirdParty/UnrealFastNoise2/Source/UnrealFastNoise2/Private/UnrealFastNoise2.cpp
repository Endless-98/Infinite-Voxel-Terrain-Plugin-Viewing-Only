...
{
	const FString BaseDir = IPluginManager::Get().FindPlugin("InfiniteVoxelTerrainPlugin")->GetBaseDir();
	const FString LibraryPath = FPaths::Combine(*BaseDir, "Source", "ThirdParty", "UnrealFastNoise2", TEXT(FASTNOISE_LIBRARY_PATH));
